	...
	?>
                                ...
                                <div class="row">
                                    <div class="col-lg-5 col-md-5">
                                        <div class="banner-product-img">
                                            <img src="<?php echo base_url().'assets/uploads/carousel/'.$re['picture'];?>" title="banner-img"  data-ani="slideinup" data-ani-delay="0.0s">
                                        </div>
                                    </div>
                          ...
                          <!--div class="swiper-slide">
                                <div class="row">
                                    <div class="col-lg-5 col-md-5">
                                        <div class="banner-product-img">
                                            <img src="<?php //echo base_url().'electricalshop/assets/img/e-shop/banner-2.png';?>" title="banner-img"  data-ani="slideinup" data-ani-delay="0.0s">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div class="product-details">
                                            <div class="hero-style3">
                                                <span class="hero-subtitle" data-ani="slideinup" data-ani-delay="0.0s">Welcome to Electrical Junction</span>
                                                <h1 class="hero-title2">
                                                    <span class="title1" data-ani="slideinup" data-ani-delay="0.2s">CIRCUIT BREAKER</span>
                                                    <span class="title2" data-ani="slideinup" data-ani-delay="0.3s">Best price </span>
                                                </h1>
                                                <p class="hero-text" data-ani="slideinup" data-ani-delay="0.5s">Upto 10% Offer</p>
                                                <a href="#" class="th-btn style4" data-ani="slideinup" data-ani-delay="0.6s">Shop Now<i class="fas fa-chevrons-right ms-2"></i></a>
                                            </div>
                                        </div>
                                    </div>
                           ...
                           <!--div class="swiper-slide">
                            <div class="row">
                                <div class="col-lg-5 col-md-5">
                                    <div class="banner-product-img">
                                        <img src="<?php //echo base_url().'electricalshop/assets/img/e-shop/banner-3.png';?>" title="banner-img"  data-ani="slideinup" data-ani-delay="0.0s">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <div class="product-details">
       ...
       // $this->db->order_by("orderno", "asc");
        ...
        ?>
                        ...
                        <!--div class="swiper-slide">
                            <div class="th-product product-grid">
                                <div class="product-img">
                                    <img src="<?php echo base_url().'electricalshop/assets/img/e-shop/product-2.png';?>" alt="Product Image">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="#">ENCLOSURES</a></h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod</p>
                                  
                                   
                                </div>
                                <div class="btn-area mt-4">
                                    <a href="#" class="th-btn btn-sm">View More</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                <div class="product-img">
                                    <img src="<?php echo base_url().'electricalshop/assets/img/e-shop/product-3.png';?>" alt="Product Image">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="#">VALVE & ACTUATORS</a></h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod</p>
       ...
       // $this->db->order_by("orderno", "asc");
        ...
        ?>
                            ...
                            <div class="swiper-slide">
                                <div class="th-product product-grid">
                                    <div class="product-img">
                                        <img src="<?php echo base_url().'electricalshop/assets/img/e-shop/product/4.png';?>" alt="Product Image">
                                        <span class="product-tag">10% OFF</span>
                                        <span class="product-tag-second">Sale</span>
                                        <div class="actions">
                                            <a href="#" class="icon-btn popup-content"><i class="far fa-eye"></i></a>
                            ...
                            <div class="swiper-slide">
                                <div class="th-product product-grid">
                                    <div class="product-img">
                                        <img src="<?php echo base_url().'electricalshop/assets/img/e-shop/product/5.png';?>" alt="Product Image">
                                        <span class="product-tag">10% OFF</span>
                                        <span class="product-tag-second">Sale</span>
                                        <div class="actions">
                                            <a href="#" class="icon-btn popup-content"><i class="far fa-eye"></i></a>
        ...
        <div class="container th-container">
            ...
            <div class="swiper th-slider" id="blogSlider1" data-slider-options='{"breakpoints":{"0":{"slidesPerView":2},"576":{"slidesPerView":"2"},"768":{"slidesPerView":"3"},"992":{"slidesPerView":"4"},"1200":{"slidesPerView":"5"},"1400":{"slidesPerView":"6"}}}'>
                <div class="swiper-wrapper">
                    ...
                    <!--div class="swiper-slide">
                        <div class="brand-card">
                            <img src="<?php //echo base_url().'electricalshop/assets/img/e-shop/brand/2.png';?>" alt="Brand Logo">
                        </div>
                      
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-card">
                            <img src="<?php //echo base_url().'electricalshop/assets/img/e-shop/brand/3.png';?>" alt="Brand Logo">
                        </div>
                    </div>
                
                    <div class="swiper-slide">
                        <div class="brand-card">
                            <img src="<?php //echo base_url().'electricalshop/assets/img/e-shop/brand/5.png';?>" alt="Brand Logo">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-card">
                            <img src="<?php //echo base_url().'electricalshop/assets/img/e-shop/brand/6.png';?>" alt="Brand Logo">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-card">
                            <img src="<?php //echo base_url().'electricalshop/assets/img/e-shop/brand/7.png';?>" alt="Brand Logo">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-card">
                            <img src="<?php //echo base_url().'electricalshop/assets/img/e-shop/brand/8.png';?>" alt="Brand Logo">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-card">
                            <img src="<?php //echo base_url().'electricalshop/assets/img/e-shop/brand/9.png';?>" alt="Brand Logo">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-card">
                            <img src="<?php echo base_url().'electricalshop/assets/img/e-shop/brand/10.png';?>" alt="Brand Logo">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-card">
                            <img src="<?php echo base_url().'electricalshop/assets/img/e-shop/brand/11.png';?>" alt="Brand Logo">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-card">
                            <img src="<?php echo base_url().'electricalshop/assets/img/e-shop/brand/12.png';?>" alt="Brand Logo">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-card">
                            <img src="<?php echo base_url().'electricalshop/assets/img/e-shop/brand/13.png';?>" alt="Brand Logo">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-card">
                            <img src="<?php echo base_url().'electricalshop/assets/img/e-shop/brand/14.png';?>" alt="Brand Logo">
                        </div>
                    </div--->
                </div>
                        ...
                        <div class="widget footer-widget">
                            <div class="th-widget-about">
                                ...
                                <div class="th-social">
                                    ...
                                    <a href="<?php //echo $sitedetails['site_twitter_url']?>"><i class="fab fa-twitter"></i></a>
                                    <a href="#"><i class="fab fa-linkedin-in"></i></a>
                                    <a href="tel:<?=$sitedetails['whatsapp']?>"><i class="fab fa-whatsapp"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- whatsapp -->
    <div class="button__cover">
        <a href="tel:<?=$sitedetails['phone_number_1']?> "><i class="fab fa-whatsapp"></i></a>
