    ...
    <div class="mobile-nav">
        <a href="<?=site_url()?>" class="logo">
            ...
            <!--img src="<?//=base_url().'assets/uploads/site/'.$gt->site_mobile_logo//$sitedetails['mobile_logo']?>" style="width:60px;" class="logo-two" alt="<?//=$sitedetails['sitename']?>"-->
             <img src="<?=$sitedetails['logo']?>" style="width:160px;background-color:#009e4d;" class="logo-one" alt="<?=$sitedetails['sitename']?>">
            <img src="<?=$sitedetails['mobile_logo']?>" style="width:60px;background-color:#009e4d;" class="logo-two" alt="<?=$sitedetails['sitename']?>">
        </a>
    </div>
...
<a class="navbar-brand" href="<?=site_url()?>">
                        <img src="<?=$sitedetails['logo']?>" style="width:160px;background-color:#009e4d;" alt="<?=$sitedetails['sitename']?>">
                    </a>
                    <a class="navbar-brand-sticky" href="<?=site_url()?>">
                        <img src="<?=$sitedetails['mobile_logo']?>" style="width:160px;background-color:#009e4d;" alt="<?=$sitedetails['sitename']?>">
                    </a>
