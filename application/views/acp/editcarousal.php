                                ...
                                <form id="editcarousal">
                                    <div class="form-group row">
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $carousal->carouselid;?>" placeholder="Enter Menu Name" required>
                                            ...
                                            <label for="company-name" class="col-form-label">Title1:</label>
                                                              <input type="text" class="form-control" id="title" name="title" placeholder="Enter Title1" required maxlength="300" value="<?php echo $carousal->title;?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label for="company-logo" class="col-form-label">Image1:</label>
                                                              ...
                                                              <img src="<?php echo base_url().'assets/uploads/carousel/'.$carousal->picture;?>" width="50" height="50" />
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <div class="col-md-12 mb-3">
                                        <label for="contact-person" class="col-form-label">Title2:</label>
                                                              <input type="text" class="form-control" id="title2" name="title2" placeholder="Enter Title2" required maxlength="300" value="<?php echo $carousal->title2;?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label for="contact-person" class="col-form-label">Title3:</label>
                                                              <input type="text" class="form-control" id="title3" name="title3" placeholder="Enter Title3" required maxlength="300" value="<?php echo $carousal->title3;?>">
                                    ...
                                    <label for="status" class="col-form-label">Status:</label>
                                                              ...
                                                              <select class="form-control" placeholder="Select Status" name="status" id="status"  data-bs-original-title="" title="" required>
                                                                ...
                                                                <option value="1" <?php if ($carousal->active=='1'){?> selected <?php }?>>Active </option>
                                                                <option value="0" <?php if ($carousal->active=='0'){?> selected <?php }?>>Inactive </option>
</select> </div>
</select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label for="contact-person" class="col-form-label">Title4:</label>
                                                              <input type="text" class="form-control" id="title4" name="title4" placeholder="Enter Title4" required maxlength="300" value="<?php echo $carousal->title4;?>">
                                    ...
                                    <div class="submit-btn-area" style="width:15%;float:right;min-width: 200px;">
                                        ...
                                        <button id="saveBrandSubmit1" type="submit"><?=(($page_title == 'Edit Carousel')? 'Save Carousel' : 'Update Carousel')?><i class="ti-arrow-right"></i></button>
    ...
    e.preventDefault();
       ...
       var file_data1 = $('#image1').prop('files')[0];
        ...
        $(this).val('');
               ...
               window.location.href ="<?php echo base_url().'acp/Settings/listcarousal';?>";
            },
            error: function (response) {
...
$('#editcarousal').on('submit', function (e) {
    ...
    //alert("add");
       var file_data1 = $('#image1').prop('files')[0];
        ...
        $.ajax({
            url: "<?php echo base_url().'acp/Settings/editcarousalprocess';?>", // point to server-side controller method
            dataType: 'text', // what to expect back from the server
            cache: false,
            contentType: false,
            processData: false,
