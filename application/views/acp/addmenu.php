                            ...
                            <div class="formArea">
                                ...
                                <form id="menufrm">
                                    ...
                                    <div class="submit-btn-area" style="width:15%;float:right;min-width: 200px;">
                                        ...
                                        <button id="saveBrandSubmit1" type="submit"><?=(($page_title == 'Add Menu')? 'Add Menu' : 'Add Menu')?><i class="ti-arrow-right"></i></button>
...
$('#menufrm').on('submit', function (e) {
   ...
   //alert("enter");
        ...
        $.ajax({
            url: "<?php echo base_url().'acp/Settings/savemenu';?>", // point to server-side controller method
