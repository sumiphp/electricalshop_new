    ...
    <tbody>
        ...
        foreach ($productbrands as $k => $brandVal) {
            ...
            <tr>
                ...
                <td><?=truncateString($brandVal['brand_desc'], 50);?></td>
                <td><?=date(SITE_DATE_FORMAT.' '.SITE_TIME_FORMAT, $brandVal['unix_brand_updated_date'])?></td>
                <td>
                    <ul class="d-flex justify-content-center">
                        <li title="View" class="mr-3"><a href="<?=site_url()?>acp/Brand/view/<?=$brandVal['brand_id']?>" class="text-secondary"><i class="fa fa-eye"></i></a></li>
                        <li title="Edit" class="mr-3"><a href="<?=site_url()?>acp/Brand/edit/<?=$brandVal['brand_id']?>" class="text-secondary"><i class="fa fa-pencil"></i></a></li>
