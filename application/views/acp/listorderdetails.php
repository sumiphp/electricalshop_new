...
<body>
        ...
        <div class="main-content">
            ...
            <div class="main-content-inner p-0">
                <div class="col-12 p-0 mt-5X">
                    <div class="card">
                        <div class="card-body">
                            <div class="data-tables datatable-dark dataTable-carousal"></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!--script src="<?//=site_url()?>assets/js/acp/brands.js?c=<?=date('siHYmd')?>"></script-->
       ...
       <script src="<?=site_url()?>assets/js/acp/ordersdetails.js?c=<?=date('siHYmd')?>"></script>
    <script type="text/javascript">
        $(function() {
            //Brands.init();
            //carousal1.init();
var ordid=68;
billingdetails.init(ordid);
