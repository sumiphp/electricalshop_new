...
<div class="space bg-blue">
        <div class="container th-container">
            ...
            <?php 
                ...
                <!--div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/2.png';?>" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/3.png';?>" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/4.png';?>" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/5.png';?>" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/6.png';?>" alt="Brand Logo">
                    </div>
                </div>

                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/7.png';?>" alt="Brand Logo">
                    </div>
                </div>

                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/8.png';?>" alt="Brand Logo">
                    </div>
                </div>

                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/9.png';?>" alt="Brand Logo">
                    </div>
                </div>

                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/10.png';?>" alt="Brand Logo">
                    </div>
                </div>

                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/11.png';?>" alt="Brand Logo">
                    </div>
                </div>

                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/12.png';?>" alt="Brand Logo">
                    </div>
                </div>

                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/13.png';?>" alt="Brand Logo">
                    </div>
                </div>

                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/14.png';?>" alt="Brand Logo">
                    </div>
                </div>

                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/15.png';?>" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/16.png';?>" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/17.png';?>" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/18.png';?>" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/19.png';?>" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/20.png';?>" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/21.png';?>" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/22.png';?>" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/23.png';?>" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/24.png';?>" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/25.png';?>" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/26.png';?>" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/27.png';?>" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/28.png';?>" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/29.png';?>" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/30.png';?>" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/31.png';?>" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/32.png';?>" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/33.png';?>" alt="Brand Logo">
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="brand-card">
                        <img src="<?php //echo base_url().'electricalshop1/assets/img/e-shop/brand/34.png';?>" alt="Brand Logo">
                    </div>
                </div---->
