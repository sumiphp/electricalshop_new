...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        //D:/xampp/htdocs/nexa-electricalshop/assets/bulkupload/server/php/files/
        //D:/xampp/htdocs/nexa-electricalshop/assets/bulkupload/server/php/index.php

        //echo $this->get_server_var('SCRIPT_FILENAME');
        //echo dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/';
        //echo $this->get_full_url().'/files/';
       //die;
        $this->options = array(
            'script_url' => $this->get_full_url().'/'.$this->basename($this->get_server_var('SCRIPT_NAME')),
            //'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/',
            'upload_dir' => 'D:/xampp/htdocs/nexa-electricalshop/assets/uploads/products/',
            //'upload_url' => $this->get_full_url().'/files/',
             'upload_url' => 'http://localhost/nexa-electricalshop/assets/uploads/products/',
